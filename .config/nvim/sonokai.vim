...
function! sonokai#get_palette(style) "{{{
  if a:style ==# 'default'
    let palette = {
          \ 'black':      ['#191919',   '237',  'DarkGrey'],
          \ 'bg0':        ['#262626',   '235',  'Black'],
          \ 'bg1':        ['#323232',   '236',  'DarkGrey'],
          \ 'bg2':        ['#464646',   '236',  'DarkGrey'],
          \ 'bg3':        ['#525252',   '237',  'DarkGrey'],
          \ 'bg4':        ['#646464',   '237',  'Grey'],
  ...
  elseif a:style ==# 'shusia'
    let palette = {
          ...
          \ 'bg1':        ['#262626',   '236',  'DarkGrey'],
          \ 'bg2':        ['#323232',   '236',  'DarkGrey'],
          \ 'bg3':        ['#525252',   '237',  'DarkGrey'],
          \ 'bg4':        ['#646464',   '237',  'Grey'],
          \ 'bg_red':     ['#ff6565',   '203',  'Red'],
          \ 'diff_red':   ['#55393d',   '52',   'DarkRed'],
          \ 'bg_green':   ['#2cc46c',   '107',  'Green'],
          \ 'diff_green': ['#394634',   '22',   'DarkGreen'],
          \ 'bg_blue':    ['#6f97ec',   '110',  'Blue'],
          \ 'diff_blue':  ['#354157',   '17',   'DarkBlue'],
          \ 'diff_yellow':['#ecc46f',   '54',   'DarkMagenta'],
          \ 'fg':         ['#e3e1e4',   '250',  'White'],
          \ 'red':        ['#f85e84',   '203',  'Red'],
